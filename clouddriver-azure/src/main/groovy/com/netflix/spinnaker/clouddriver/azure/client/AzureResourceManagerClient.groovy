...
class AzureResourceManagerClient extends AzureBaseClient {
  ...
  private Deployment createTemplateDeployment(
    ...
    try {
      String parameters = convertParametersToTemplateJSON(mapper, templateParameters)
  ...
  String convertParametersToTemplateJSON(ObjectMapper mapper, Map<String, Object> sourceParameters) {
  ...
  class ValueParameter extends Object {
    Object value
  ...
  class ReferenceParameter extends Object {
    Object reference
